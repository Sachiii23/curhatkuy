        ...
        <div class="container pb-5">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="profile-card">
                        <div class="profile-img-wrapper">
                            <img src="<?php echo base_url('img/psikologsyahcra.png'); ?>" alt="Syahcra Shafa Kamila" class="profile-img">
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="profile-card">
                        <div class="profile-img-wrapper">
                            <img src="<?php echo base_url('img/psikologadel.png'); ?>" alt="Adellya Salsabila" class="profile-img">
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="profile-card">
                        <div class="profile-img-wrapper">
                            <img src="<?php echo base_url('img/psikologian.png'); ?>" alt="Sufyaan Gymnastiar" class="profile-img">
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="profile-card">
                        <div class="profile-img-wrapper">
                            <img src="<?php echo base_url('img/psikologmanda.png'); ?>" alt="Manda Aulia" class="profile-img">
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="profile-card">
                        <div class="profile-img-wrapper">
                            <img src="<?php echo base_url('img/psikologdinda.png'); ?>" alt="Adinda Deswita" class="profile-img">
                        </div>
