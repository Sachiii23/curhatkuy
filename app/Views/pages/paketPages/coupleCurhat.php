...
<body>
    ...
    <div class="container">
        ...
        <h1 class="page-title text-center mb-3">Couple Curhat</h1>

        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center">
                <p class="section-description">
                    Kuy Curhat adalah ruang aman bagi kamu untuk berbagi cerita dan menemukan solusi bersama psikolog profesional. 
                    Kami hadir untuk mendengarkan tanpa menghakimi, membantu meredakan kecemasan, dan menemani langkahmu menuju mental yang lebih sehat. 
                    Pilih psikolog yang sesuai dengan kebutuhanmu di bawah ini.
                </p>
            </div>
        </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="profile-card">
                    ...
                    <p class="profile-role"><?= esc($p['spesialisasi']); ?></p>
                    <p class="profile-role">
                        Rp.<?= number_format($p['harga'], 0, ',', '.'); ?>/jam
                    </p>
                    <div class="action-buttons-wrapper">
                        <a href="<?php echo base_url('index3/detail/1'); ?>" class="btn-profile-action">Lihat profil</a>
