...
<body>
    ...
    <div class="container">
        ...
        <h1 class="page-title text-center mb-3">Paket Curhat</h1>

        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center">
                <p class="section-description">
                    Paket Curhat adalah ruang aman bagi kamu untuk berbagi cerita dan menemukan solusi bersama psikolog profesional. 
