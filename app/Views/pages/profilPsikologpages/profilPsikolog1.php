...
<div class="container-fluid sticky-top bg-white shadow-sm" style="z-index: 1020;">
        <div class="container px-5">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                <a href="<?php echo base_url(); ?>" class="navbar-brand d-flex align-items-center">
                    <img src="<?php echo base_url('img/curhatkuy_logo_new.png'); ?>" alt="Logo" style="width: 40px; height: 40px;">
                    <h1 class="m-0 text-primary d-flex align-items-center ps-2" style="font-size: 1.5rem;">CurhatKuy!</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="<?php echo base_url('home/psikolog') ?>" class="nav-item nav-link active" style="color: #00A6FB !important;">Psikolog</a>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-12">
                    ...
                    <div class="profile-header-wrapper">
                        ...
                        <img src="<?php echo base_url('img/psiko-Syachra Shafa Kamila.png'); ?>" alt="Syachra Shafa Kamila" class="main-profile-img">
                    </div>

                    <h1 class="profile-name-large">Syachra Shafa Kamila</h1>
